...
export default function CourseDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { data: course, isLoading, isError } = useQuery({ queryKey: ["course", slug], queryFn: async () => (await api.get(`/courses/${slug}`)).data });
